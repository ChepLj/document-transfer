...
function postDataToStorage (image: any, childRef: string,fileName: string, callback :Function , progressCallback: Function, metaData:any , uploadTaskCallback?:Function) {
// Upload file and metadata to the object 'images/mountains.jpg'
const storageRef = ref(storage, childRef + fileName);
const uploadTask = uploadBytesResumable(storageRef, image, metaData);
console.log("🚀 ~ file: postDataToStorage.ts:9 ~ postDataToStorage ~ uploadTask:", uploadTask)
